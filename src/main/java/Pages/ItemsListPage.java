...
public class ItemsListPage extends UtilitiesMethods {
    ...
    public String get_first_shown_item_name_before_any_process() {
        ...
        items_list_element = driver.findElement(By.xpath("//div[@class='result-list']"));
        shown_items = items_list_element.findElements(By.xpath("//div[@class='result-list']//div[@class='list-row']//a"));
